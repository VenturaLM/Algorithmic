...
int traveling_salesman_backtracking_algorithm()
{
	...
	try
	{
		...
		if(type == "CITY")
		{
			...
			float threshold = traveling_salesman_greedy(*g, newGraph);	//	Comment this line if you are not using "Andalucia.txt" file and uncomment the next line: [float threshold = FLT_MAX;]
