...
/**
 * @brief Template specialization to create a City graph from txt representation.
 * Template specialization is to save space.
 * For the edges only the city's name is used.
 *
 * Input Format:
 *
 ...
 * ... 
 * <NUM-EDGES>
 * <CITY_U.NAME> <CITY_V.NAME> <DISTANCE>
 * ...
