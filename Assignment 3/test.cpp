...
int 
traveling_salesman_greedy_algorithm();
...
main()
{
	...
	do
	{
		std::cout << " 1. Traveling salesman greedy algorithm." << std::endl;
...
int traveling_salesman_greedy_algorithm()
{
	...
	try
	{
		...
		if(type == "CITY")
		{
			...
			traveling_salesman_greedy(*g, newGraph); //Creates a new random graph from the old graph
