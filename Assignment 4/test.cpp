...
int 
traveling_salesman_dynamic_algorithm();
...
main()
{
    ...
    do
    {
    	std::cout << " 1. Traveling salesman dynamic algorithm." << std::endl;
...
int traveling_salesman_dynamic_algorithm()
{
    ...
    try
    {
        ...
        if(type == "CITY")
        {
            ...
            traveling_salesman_dynamic(*g); //deep travel of the graph g
        }
        else
        {
